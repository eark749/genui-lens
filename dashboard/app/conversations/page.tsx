  ...
  return (
    <div>
      ...
      <div className="mt-6 p-4 bg-blue-50 dark:bg-blue-950/20 rounded-lg border border-blue-100 dark:border-blue-900/40 text-xs text-blue-700 dark:text-blue-400 space-y-1">
        ...
        <p><strong className="text-purple-700 dark:text-purple-400">Purple chips</strong> — interactive components · <strong>Gray chips</strong> — display-only (charts, cards)</p>
      </div>
    </div>
  );
}
